      ...
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4 me-xl-8">
          ...
          <a href="/" class="app-brand-link">
                ...
                <img src="{{ asset('frontend/assets/img/front-pages/branding/LogoOneducPositionG.svg')}}" width="237" height="69">
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link fw-medium" aria-current="page" href="landing-page.html#landingHero">Accueil</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mega-dropdown">
              <a
                ...
                data-trigger="hover">
                <span data-i18n="Pages">Formations</span>
              </a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown" data-trigger="hover">Association</a>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('association')}}">L'association</a>
                  <a class="dropdown-item" href="{{route('adhesion')}}">Adhésion</a>
                  <a class="dropdown-item" href="javascript:void(0)">Contactez-nous</a>
                </div>
              </li>
          </ul>
        </div>
