...
<html
  ...
  <head>
    ...
    <title>Mot de passe oublié Basic - Pages | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="authentication-inner py-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-6">Saisissez votre adresse électronique et nous vous enverrons des instructions pour réinitialiser votre mot de passe.</p>
              <form id="formAuthentication" class="mb-6" action="auth-reset-password-basic.html" method="GET">
                ...
                <button class="btn btn-primary d-grid w-100">Envoyer lien de réinitialisation</button>
              </form>
