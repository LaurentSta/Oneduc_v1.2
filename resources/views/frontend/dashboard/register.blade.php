...
<html
  ...
  <head>
    ...
    <title>Inscription Couverture - Pages | Vuexy - Template Admin Bootstrap</title>
              ...
              <div class="mb-6 mt-8">
                <div class="form-check mb-8 ms-2">
                  ...
                  <label class="form-check-label" for="terms-conditions">
                    J'accepte la <a href="javascript:void(0);">politique de confidentialité et les conditions</a>
                  </label>
                </div>
              </div>
