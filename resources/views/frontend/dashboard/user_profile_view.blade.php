                ...
                <div class="card mb-6">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="{{ file_exists(public_path('upload/user_images/'.$profileData->photo)) ? asset('upload/user_images/'.$profileData->photo) : asset('upload/NoPhoto.png') }}" alt="user-avatar" class="d-block h-auto ms-0 ms-sm-6 rounded user-profile-img" style="max-width: 150px; max-height: 150px; object-fit: cover;">
                        </div>
