        ...
        <div class="card mb-6">
            ...
            <div class="row g-6">
                <div class="col-md-6">
                    ...
                    <input type="text" id="multicol-first-name" class="form-control" placeholder="Laurent" />
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">Nom *</label>
                    <input type="text" id="multicol-last-name" class="form-control" placeholder="Dupont" />
                </div>
                <div class="col-md-6">
                <label class="form-label" for="multicol-username">Société ou Asso</label>
                <input type="text" id="multicol-username" class="form-control" placeholder="ABC insertion" />
                </div>
                <div class="col-md-6">
